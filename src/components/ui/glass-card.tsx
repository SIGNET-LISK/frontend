  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-white/[0.03] backdrop-blur-[8px] border border-white/[0.08]",
        "shadow-[0_8px_32px_rgba(0,0,0,0.4)]",
        hoverEffect && "hover:translate-y-[-4px] hover:bg-white/[0.05] hover:border-white/[0.12] hover:shadow-[0_12px_48px_rgba(100,130,255,0.12)]",
        className
      )}
      {...props}
    >
