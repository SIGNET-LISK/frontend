        ...
        <div className={cn(
          ...
          <DialogHeader className="w-full flex flex-col items-center">
            ...
            <DialogDescription className="text-base text-gray-700 dark:text-white/80 text-center leading-relaxed px-2">
              Your wallet address is not registered as an authorized publisher. Only verified publishers can access the dashboard.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="w-full py-6">
            <div className="rounded-xl bg-gray-600/5 dark:bg-white/5 p-4 text-sm text-gray-600 dark:text-white/60 text-center border border-gray-200 dark:border-white/5">
              Please contact the administrator to request publisher access for your wallet address.
            </div>
          </div>
          ...
          <DialogFooter className="flex-col sm:flex-row gap-3 w-full">
            ...
            <Button 
              ...
              onClick={() => window.location.href = "mailto:admin@signet.com?subject=Request Publisher Access"}
            >
