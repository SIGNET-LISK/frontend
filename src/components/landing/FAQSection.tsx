...
const FAQ_ITEMS = [
    ...
    {
        q: "Why blockchain?",
        a: "Once stored on the blockchain, fingerprints cannot be modified, deleted, or tampered with, providing an immutable and verifiable record of authenticity. We use Lisk L2 for high speed and low costs.",
    },
    {
        q: "Who is SIGNET for?",
