  ...
  return (
    <Layout>
      <header className="mb-8">
        <h2 className="text-3xl font-bold text-white">API Usage</h2>
        <p className="text-gray-400 mt-1">Monitor your API consumption and manage access keys.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <GlassCard>
                <p className="text-gray-400 text-sm uppercase tracking-wider mb-2">Total Requests</p>
                <h3 className="text-3xl font-bold text-white">19,550</h3>
                <p className="text-green-400 text-sm mt-2">Top 10% of users</p>
             </GlassCard>
             <GlassCard>
                <p className="text-gray-400 text-sm uppercase tracking-wider mb-2">Avg. Latency</p>
                <h3 className="text-3xl font-bold text-white">124ms</h3>
            ...
            <div className="relative pt-4">
               ...
               <div className="flex items-start gap-3 mt-6 p-3 rounded-xl bg-orange-500/10 border border-orange-500/20">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-orange-200/70">You are approaching your monthly limit. Consider upgrading.</p>
                  </div>
               </div>
               <GlowButton className="w-full mt-6" variant="secondary">Upgrade Plan</GlowButton>
            </div>
          </GlassCard>
