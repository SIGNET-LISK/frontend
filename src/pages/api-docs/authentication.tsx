          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white-100 text-sm">
                  Click "Generate API Key" to create a new key. Store it
...
data = response.json()`}
          ...
          <div>
            <h3 className="text-lg font-semibold text-white-100 mb-3">cURL</h3>
            <CodeBlockGlass
              title="cURL Example"
        ...
        <GlassCard>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              ...
              <p className="text-white-100 text-sm">This error occurs when:</p>
              <ul className="list-disc list-inside text-white-100 text-sm mt-2 space-y-1">
          ...
          <ul className="space-y-3 text-white-100">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                in client-side code, public repositories, or logs
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-blue-400 mt-1">✓</span>
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and revoke compromised keys immediately
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-blue-400 mt-1">✓</span>
              <span>
                <strong className="text-white-100">Use HTTPS only</strong> when
                making API requests
              </span>
            </li>
            <li className="flex items-start gap-3">
