  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <section className="space-y-6">
        <div>
          ...
          <p className="text-xl text-white-100 leading-relaxed">
            The official SIGNET JavaScript SDK makes it easy to integrate
            content verification and registration into your Node.js or
      ...
      <section className="space-y-6">
        ...
        <CodeBlockGlass title="npm" code={`npm install @signet/sdk`} />
        <CodeBlockGlass title="yarn" code={`yarn add @signet/sdk`} />
        <CodeBlockGlass title="pnpm" code={`pnpm add @signet/sdk`} />
      </section>
      ...
      <section className="space-y-6">
        ...
        <GlassCard>
          <p className="text-white-100 mb-4">
            The SDK includes full TypeScript definitions for type safety and
