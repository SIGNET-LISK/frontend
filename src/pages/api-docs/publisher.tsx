    ...
    <div className="space-y-8 max-w-4xl">
      <section className="space-y-6">
        <div className="flex items-baseline gap-3">
          ...
          Retrieve detailed information about a specific publisher by their wallet address. 
          This endpoint provides publisher metadata, verification status, and content statistics.
        </p>
      </section>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">URL Parameters</h2>
...
const publisherData = await response.json();`}
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">wallet</code>
                <span className="text-gray-300 text-sm ml-2">String</span>
              ...
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">verified</code>
              ...
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">join_date</code>
                <span className="text-gray-300 text-sm ml-2">ISO 8601 DateTime</span>
                <p className="text-gray-100 text-sm mt-1">
                  When the publisher first registered with SIGNET.
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">statistics</code>
              ...
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">subscription</code>
                <span className="text-gray-300 text-sm ml-2">Object</span>
                <p className="text-gray-100 text-sm mt-1">
  ...
  "error": {
    ...
    "details": "Publisher with wallet address 0x7f3a...2b1c not found"
            ...
            <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              <h3 className="text-yellow-400 font-semibold mb-2">400 Bad Request</h3>
              <p className="text-gray-100 text-sm mb-2">
  ...
  "error": {
    ...
    "details": "Invalid wallet address format"
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">Use Cases</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <GlassCard>
            <h3 className="text-lg font-semibold text-white mb-2">Content Verification</h3>
            <p className="text-gray-100 text-sm">
              Verify the authenticity of content by checking publisher information and verification status.
            </p>
          </GlassCard>
          <GlassCard>
            <h3 className="text-lg font-semibold text-white mb-2">Publisher Discovery</h3>
            <p className="text-gray-100 text-sm">
              Look up publisher details to understand who registered specific content.
            </p>
          </GlassCard>
          <GlassCard>
            <h3 className="text-lg font-semibold text-white mb-2">Analytics</h3>
            <p className="text-gray-100 text-sm">
              Track publisher activity and content statistics for reporting and analysis.
            </p>
          </GlassCard>
          <GlassCard>
            <h3 className="text-lg font-semibold text-white mb-2">Trust Verification</h3>
            <p className="text-gray-100 text-sm">
              Check if a publisher is verified and active before trusting their content.
            </p>
          </GlassCard>
        </div>
      </section>
