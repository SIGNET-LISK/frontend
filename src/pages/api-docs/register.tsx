    ...
    <div className="space-y-8 max-w-4xl">
      <section className="space-y-6">
        ...
        <p className="text-xl text-white-100 leading-relaxed">
          Register a new content fingerprint on-chain. This endpoint requires
          Publisher-level permissions and is used by dashboard and enterprise
          clients to establish proof of ownership for their content.
        </p>
      </section>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-12 gap-4 py-3 border-b border-white/5">
                ...
                <div className="col-span-7">
                  <span className="text-white-100 text-sm">
                    The media file to register (max 50MB). The perceptual hash
              ...
              <div className="grid grid-cols-12 gap-4 py-3 border-b border-white/5">
                ...
                <div className="col-span-7">
                  <span className="text-white-100 text-sm">
                    Pre-calculated perceptual hash. If not provided, it will be
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="py-2 border-b border-white/5">
                ...
                <p className="text-white-100 text-sm mt-1">
                  Details about the registered content including ID, hash, and
                  metadata.
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                ...
                <span className="text-white-100 text-sm ml-2">Object</span>
                <p className="text-white-100 text-sm mt-1">
                  Blockchain transaction details including transaction hash,
                  block height, and confirmation status.
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                ...
                <p className="text-white-100 text-sm mt-1">
                  The blockchain transaction hash that can be used to verify the
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              ...
              <p className="text-white-100 text-sm">
                This endpoint requires a Publisher-level account. Free accounts
                cannot register content. Upgrade your account in the Dashboard
                to gain access to content registration.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              <h3 className="text-blue-400 font-semibold mb-2">Rate Limits</h3>
              <p className="text-white-100 text-sm">
                Registration requests are subject to rate limits based on your
                subscription plan. See the Rate Limits section for more details.
              </p>
            </div>
          </div>
        </GlassCard>
