...
export default function Verify() {
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">Request Parameters</h2>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-12 gap-4 py-3 border-b border-white/5">
                ...
                <div className="col-span-2">
                  <span className="text-gray-300 text-sm">Binary</span>
                </div>
                <div className="col-span-7">
                  <span className="text-gray-100 text-sm">
                    The media file to verify (max 50MB). Accepts images, videos, and audio files.
                  </span>
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 py-3 border-b border-white/5">
                ...
                <div className="col-span-2">
                  <span className="text-gray-300 text-sm">String</span>
                </div>
                <div className="col-span-7">
                  <span className="text-gray-100 text-sm">
                    Alternatively, provide a direct URL to the media. The API will fetch and process it.
                  </span>
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 py-3 border-b border-white/5">
                ...
                <div className="col-span-7">
                  <span className="text-gray-100 text-sm">
                    Verification mode: <code className="text-blue-300">"fast"</code> (default) or <code className="text-blue-300">"deep"</code> for more thorough analysis.
                  </span>
                </div>
              </div>
            </div>
...
const result = await response.json();`}
      ...
      <section className="space-y-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-white mb-3">Success Response (Match Found)</h3>
          <CodeBlockGlass 
  ...
  "metadata": {
    ...
    "dimensions": {
      ...
      "height": 1080
        ...
        <div>
          <h3 className="text-lg font-semibold text-white mb-3">Success Response (No Match)</h3>
          <CodeBlockGlass 
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="py-2 border-b border-white/5">
                ...
                <span className="text-gray-300 text-sm ml-2">Boolean</span>
                <p className="text-gray-100 text-sm mt-1">
                  Whether the content matches a registered fingerprint.
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">similarity_score</code>
                <span className="text-gray-300 text-sm ml-2">Number (0-100)</span>
                <p className="text-gray-100 text-sm mt-1">
                  Percentage similarity between the submitted content and the matched fingerprint.
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">hamming_distance</code>
                <span className="text-gray-300 text-sm ml-2">Number</span>
                <p className="text-gray-100 text-sm mt-1">
              ...
              <div className="py-2 border-b border-white/5">
                ...
                <span className="text-gray-300 text-sm ml-2">Object</span>
                <p className="text-gray-100 text-sm mt-1">
                  Details about the matched content and its publisher (only present if match is true).
                </p>
              </div>
              <div className="py-2 border-b border-white/5">
                <code className="text-blue-300 font-mono text-sm">blockchain_proof</code>
                <span className="text-gray-300 text-sm ml-2">Object</span>
                <p className="text-gray-100 text-sm mt-1">
                  Blockchain transaction details proving the registration (only present if match is true).
                </p>
              </div>
            </div>
          </div>
        ...
        <GlassCard>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <h3 className="text-red-400 font-semibold mb-2">422 Unprocessable Entity</h3>
  ...
  "error": {
    ...
    "details": "File format not supported"
            ...
            <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              <h3 className="text-yellow-400 font-semibold mb-2">413 Payload Too Large</h3>
              <p className="text-gray-100 text-sm mb-2">
