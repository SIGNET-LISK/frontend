          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
              ...
              >
                ...
                <div className="space-y-6 max-w-xl">
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                    ...
                    (pHash) for instant verification. Compare any content
                    against on-chain fingerprints stored immutably on Lisk L2.
                  </p>
              ...
              >
                ...
                <motion.div
                  className="relative z-10 w-full max-w-xs transform hover:scale-[1.02] transition-transform duration-500 lg:-mt-12"
                  animate={{ y: [0, -10, 0] }}
                  transition={{
                    duration: 6,
                    repeat: Infinity,
