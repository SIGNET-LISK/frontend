...
import { Server, Activity, Database, Cpu, HardDrive, Network, CheckCircle2, AlertTriangle, TrendingUp } from "lucide-react";
...
const NODE_STATUS = [
  { name: "Lisk Node 1", status: "healthy", uptime: "99.9%", latency: "12ms", blocks: "1,234,567" },
  { name: "Lisk Node 2", status: "healthy", uptime: "99.8%", latency: "15ms", blocks: "1,234,566" },
  { name: "Indexer Service", status: "healthy", uptime: "99.7%", latency: "8ms", blocks: "1,234,567" },
  { name: "API Gateway", status: "warning", uptime: "98.5%", latency: "45ms", blocks: "-" },
];
  ...
  return (
    <Layout>
      ...
      >
        ...
        <p className="text-gray-400 mt-1">Monitor infrastructure health, performance metrics, and system status.</p>
      </motion.header>
        ...
        >
          <GlassCard className="relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">System Status</p>
        ...
        >
          <GlassCard className="relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mt-1">48ms</h3>
        ...
        >
          <GlassCard className="relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">Storage Used</p>
        ...
        >
          <GlassCard className="relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">CPU Usage</p>
              ...
              <tbody className="text-sm">
                {NODE_STATUS.map((node, i) => (
                  <tr key={i} className="group hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                    ...
                    <td className="p-6 text-gray-300">{node.uptime}</td>
                    <td className="p-6 text-gray-300">{node.latency}</td>
                    <td className="p-6">
                      <span className="font-mono text-gray-300">{node.blocks}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
